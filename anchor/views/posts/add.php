...
<form method="post" action="<?php echo Uri::to('admin/posts/add'); ?>" enctype="multipart/form-data" novalidate>
	...
	<fieldset class="meta split">
		<div class="wrap">
			...
			<p>
				<label for="label-company"><?php echo __('posts.company'); ?>:</label>
				<?php echo Form::select('company', $companies, Input::previous('company'), array('id' => 'label-company')); ?>
				<em><?php echo __('posts.company_explain'); ?></em>
			</p>

			<p>
				<label for="label-department"><?php echo __('posts.department'); ?>:</label>
				<?php echo Form::select('department', $departments, Input::previous('department'), array('id' => 'label-department')); ?>
				<em><?php echo __('posts.department_explain'); ?></em>
			</p>
