	...
	<fieldset class="meta split">
		<div class="wrap">
			...
			<p>
				...
				<?php echo Form::select('company', $companies, Input::previous('company', $article->company), array('id' => 'label-company')); ?>
				<em><?php echo __('posts.company_explain'); ?></em>
			</p>

			<p>
				<label for="label-department"><?php echo __('posts.department'); ?>:</label>
				<?php echo Form::select('department', $departments, Input::previous('department', $article->department), array('id' => 'label-department')); ?>
				<em><?php echo __('posts.company_explain'); ?></em>
			</p>
